...
\fancypagestyle{CL}{
	...
	\fancyhead[L]{%
        ...
        \end{textblock*}
        \begin{textblock*}{6.25in}(2.1in, 0.75in)
            \large\textbf{The University of Texas at Austin} \\
            \normalsize Department of Something Great
        \end{textblock*}
        \begin{textblock*}{6.25in}(2.1in, 1.2in)
            ...
            512-123-4567\hspace{1ex}\textbullet\hspace{1ex}admin@utexas.edu}
        \end{textblock*}
...
\fancypagestyle{CV}{
	...
	\fancyhead[L]{\textbf{\huge{\textcolor{Burnt Orange}{Stanley Ipkiss}}{\Large,\hspace{1ex}Ph.D.}}\\[3pt]
        ...
        Austin, TX 78712 \\[3pt]
        \includegraphics[width=1ex]{figures/icon_mobile_phone.png} 512-123-4567 \textcolor{Burnt Orange}{~|~}
